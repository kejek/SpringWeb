...
@ComponentScan({ "com.mjg.*" })
@PropertySources({ @PropertySource(value = "classpath:application.properties"),
		@PropertySource(value = "file:${catalina.home}/conf/mw.application.properties", ignoreResourceNotFound = true) })
public class HibernateConfiguration {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { "com.mjg.persistence.entity" });
	...
	public DataSource dataSource() {
		...
		try{
		    ...
		    Integer.parseInt(environment.getRequiredProperty("c3p0.min_size"));
			...
			dataSource.setMaxIdleTime(Integer.parseInt(environment.getRequiredProperty("c3p0.timeout")));
		}
		catch(Exception e){
			logger.error(e);
		}
